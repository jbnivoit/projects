...
public class GC : Fontable {
  ...
  /** X GC values. */
  public /*static*/ class Values : ValueList {
    public static readonly Values EMPTY = new Values ();
    public Values () : base (23) {}
    ...
    /** src AND NOT dst. */
    public const int AND_REVERSE = 2;
  
    /** src. */
    public const int COPY = 3;
    
    /** NOT src AND dst. */
    public const int AND_INVERTED = 4;
  
    /** dst. */
    public const int NOOP = 5;
    ...
    /** NOT src AND NOT dst. */
    public const int NOR = 8;
  
    /** NOT src XOR dst. */
    public const int EQUIV = 9;
  
    /** NOT dst. */
    public const int INVERT = 10;
  
    /** src OR NOT dst. */
    public const int OR_REVERSE = 11;
  
    /** NOT src. */
    public const int COPY_INVERTED = 12;
  
    /** NOT src OR dst. */
    public const int OR_INVERTED = 13;
  
    /** NOT src OR NOT dst. */
    public const int NAND = 14;
    ...
    public const int ON_OFF_DASH = 1;
    public const int DOUBLE_DASH = 2;
    ...
    public const int NOT_LAST = 0;
    public const int BUTT = 1;
    public const int CAP_ROUND = 2;
    public const int PROJECTING = 3;
    ...
    public const int OPAQUE_STIPPLED = 2;
    public const int STIPPLED = 3;
    ...
    public const int CLIP_BY_CHILDREN = 0;
    public const int INCLUDE_INTERIORS = 1;
     ...
     */
    public void set_graphics_exposures (bool b) { set (16, b); }
    ...
    public const int CHORD = 0;
    public const int PIE_SLICE = 1;
   ...
   */
  public GC (Drawable drawable) : this (drawable, Values.EMPTY) {}
  ...
  /**
   * @see #change(GC.Values)
   * @see Values#set_graphics_exposures(bool)
   */
  public void set_graphics_exposures (bool b) {
    Values gc_values = new Values ();
