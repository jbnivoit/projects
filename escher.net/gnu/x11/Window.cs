...
public class Window : Drawable {
  ...
  /** Predefined. */
  public Window (int id) : base (id) { }

  /** Intern. */
  public Window (Display display, int id) :base (display, id) { }
  ...
  /** X window attributes. */
  public /*static*/ class Attributes : ValueList {
	public static readonly Attributes EMPTY = new Attributes ();
    public Attributes () : base (15) {}
     ...
     */
    public void set_override_redirect (bool b) { set (9, b); }


    /** 
     * @param b default: false
     */
    public void set_save_under (bool b) { set (10, b); }
  ...
  public const int COPY_FROM_PARENT = 0;
  public const int INPUT_OUTPUT = 1;
  public const int INPUT_ONLY = 2;
  ...
  public /*static*/ class AttributesReply : Data {
    public AttributesReply (Data data) :base (data) { }
  
  
    public const int UNMAPPED = 0;
    public const int UNVIEWABLE = 1;
    public const int VIEWABLE = 2;
    ...
    public bool override_redirect () { return read_bool (27); }
  }
   ...
   */  
  public void change_save_set (bool mode) {
  ...
  /** X window changes. */
  public /*static*/ class Changes : ValueList {
    public Changes () :base (7) { } 
    ...
    public const int TOP_IF = 2;
    public const int BOTTOM_IF = 3;
  ...
  public const int RAISE_LOWEST = 0;
  public const int LOWER_HIGHEST = 1;
  ...
  public /*static*/ class GeometryReply : Data {
  ...
  /** Reply of {@link #tree()}. */
  public /*static*/ class TreeReply : Data {
    public Display display;
	...
	private /*static*/ class ChildrenEnum : Enum
	{
		private TreeReply owner;
		public ChildrenEnum(TreeReply owner, int val, int c)
			: base(owner,val,c) { this.owner=owner; }
        public override Object next () {
          return intern (owner.display, next4 ());
        }
	}

    public Enum children () {
      return new ChildrenEnum (this, 32, children_count ());
    }
  }
  ...
  /** Reply of {@link #property(bool, Atom, Atom, int, int)}. */
  public /*static*/ class PropertyReply : Data {
    public PropertyReply (Data data) :base (data){ }
   ...
   */
	private /*static*/ class PropertiesEnum : Enum {
	private Display display;
	public PropertiesEnum(Display display, Data owner, int len, int c) : base(owner,len,c) { this.display=display; }
      public override Object next () {
  ...
  public Enum properties () {
    ...
    Data reply = display.read_reply (request);
    return new PropertiesEnum (display, reply, 32, reply.read2 (8));
  }
  ...
  public const int ALREADY_GRABBED = 1;
  public const int INVALID_TIME = 2;
  public const int NOT_VIEWABLE = 3;
  ...
  public const int ANY_BUTTON = 0;
  public const int ANY_MODIFIER = 0x8000;
  ...
  public /*static*/ class PointerReply : Data {
    public Display display;
  ...
  public /*static*/ class MotionEventsReply : Data {
    public MotionEventsReply (Data data) :base (data) { }
  }
  ...
  public /*static*/ class CoordinateReply : Data {
    public CoordinateReply (Data data) : base (data) { }
  }
  ...
  public static readonly Window POINTER_ROOT = new Window (1);


  public const int TO_NONE = 0;
  public const int TO_POINTER_ROOT = 1;
  public const int TO_PARENT = 2;
   ...
   */
	private /*static*/ class InstalledColormapsEnum : Enum
 {
	private Window owner;
	public InstalledColormapsEnum(Window owner, Data reply, int len, int c) : base(reply,len,c) { this.owner=owner; }
      public override Object next () {
  ...
  public Enum installed_colormaps () {
    ...
    Data reply = display.read_reply (request);
    return new InstalledColormapsEnum (this, reply, 32, reply.read2 (8));
  }
   ...
   * @see #clear_area(int, int, int, int, bool)
   */
  public void clear (bool exposures) {
   ...
   * (MOD5).
   *
   * @see #grab_key(int, int, bool, int, int)
   *
   * @see #grab_button_ignore_locks(int, int, bool, int, int, int,
   * Window, Cursor)
   */
  ...
  public bool resized (Rectangle r) {
  ...
  public void set_wm (Object app, String topic) {
    String res_class = app.GetType().ToString();
  ...
  public /*static*/ class WMClassHint {
    ...
    public bool class_Equals (String res_class) {
      if (res_class == null) return false;
      return res.EndsWith (res_class);
    }
  
  
    public bool class_Equals (WMClassHint hint) {
      if (hint == null) return false;
      return class_Equals (hint.res_class ());
    }
  
  
    public bool Equals (WMClassHint hint) {
      if (hint == null) return false;
      return res.Equals (hint.res);
    }
  
  
    public bool Equals (String res_name, String res_class) {
  ...
  public void set_wm_class_hint (String res_name, String res_class) {
    ...
    change_property (REPLACE, wm_class.Length, Atom.WM_CLASS,
      Atom.STRING, 8, ascii.GetBytes (wm_class), 0, 8);
  }


  /** X window manager hints. */
  public /*static*/ class WMHints : Data {
    public WMHints (Data data) :base (data) {}
  
  
    public const int INPUT_HINT_MASK = 1<<0;
    public const int STATE_HINT_MASK = 1<<1;
    public const int ICON_PIXMAP_HINT_MASK = 1<<2;
    public const int ICON_WINDOW_HINT_MASK = 1<<3;
    public const int ICON_POSITION_HINT_MASK = 1<<4;
    public const int ICON_MASK_HINT_MASK = 1<<5;
    public const int WINDOW_GROUP_HINT_MASK = 1<<6;
    public const int URGENCY_HINT_MASK = 1<<8;
    ...
    public const int WITHDRAWN = 0;
    public const int NORMAL = 1;
    public const int ICONIC = 3;
  ...
  public /*static*/ class WMSizeHints : Data {
    public WMSizeHints (Data data) : base (data) {}
  
  
    // reading
  
    public const int USPOSITION_MASK = 1<<0;
    public const int USSIZE_MASK = 1<<1;
    public const int PPOSITION_MASK = 1<<2;
    public const int PSIZE_MASK = 1<<3;
    public const int PMIN_SIZE_MASK = 1<<4;
    public const int PMAX_SIZE_MASK = 1<<5;
    public const int PRESIZE_INC_MASK = 1<<6;
    public const int PASPECT_MASK = 1<<7;
    public const int PBASE_SIZE_MASK = 1<<8;
    public const int PWIN_GRAVITY_MASK = 1<<9;
    ...
    public bool user_position () { return (flags () & USPOSITION_MASK) != 0; }
    public bool user_size () { return (flags () & USSIZE_MASK) != 0; }
    public bool program_position () { return (flags () & PPOSITION_MASK) != 0; }
    public bool program_size () { return (flags () & PSIZE_MASK) != 0; }
  ...
  public void set_wm_name (String wm_name) {
    change_property (REPLACE, wm_name.Length, Atom.WM_NAME,
      Atom.STRING, 8, ascii.GetBytes (wm_name), 0, 8); // support other types?
  }
  ...
  public /*static*/ class WMState : Data {
    public Display display;
  ...
  public const int MAX_WM_LENGTH = 1000;
   ...
   */
	...
	private class ProtocolsEnum : Enum
	 {
		private Display display;
		public ProtocolsEnum(Display display, PropertyReply owner, int len, int c) : base(owner,len,c) { this.display=display; }
      public override Object next () {
        return Atom.intern (display, next4 ());
      }
    }
