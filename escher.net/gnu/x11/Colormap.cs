...
/** X colormap. */
public class Colormap : Resource {
  /** 
   * Predefined colormap.
   *
   * @see Window#NONE
   */
  public static readonly Colormap COPY_FROM_PARENT = new Colormap (0);


  /** Predefined. */
  public Colormap (int id) : base(id) {}


  /** Create. */
  public Colormap (Display display) : base(display) {}

  /** Intern. */
  public Colormap (Display display, int id) : base(display, id) {
  }
  ...
  /** Reply of {@link #alloc_color_cells(bool, int, int)}. */
  public /*static*/ class ColorCellsReply : Data {
    public ColorCellsReply (Data data) : base(data) {}
  }
   ...
   */
	private class ColormapEnum : Enum {
	
		public ColormapEnum(Data reply, int len, int c) 
			: base(reply,len,c)
		{}
   ...
   * @see #alloc_color(int, int, int)
   */
  public Color alloc_random_color (System.Random random) {
    return alloc_color (random.Next () & 0xffff,
      random.Next () & 0xffff,
      random.Next () & 0xffff);
  }
   ...
   * @see #alloc_color(int, int, int)
   */
  public Color alloc_random_rainbow_color (System.Random random) {
