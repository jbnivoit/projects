...
public class Quadric {
  ...
  private double dr, drho, dtheta, nsign, nz;
	private float dz;
  ...
  public void cylinder (double base_radius, 
    ...
    default: throw new gnu.x11.Error ("");
    }
}
  }  
   ...
   */
  public void disk (double inner_radius, double outer_radius,
  ...
  public void partial_disk (double inner_radius, 
    ...
    this.slices = slices;
    this.loops = loops;
    this.start_radian = gnu.util.Math.toRadians (start);
    this.sweep_radian = gnu.util.Math.toRadians (sweep);
  ...
  private void sphere_fill () {
    if (texture) throw new gnu.x11.Error (""); // TODO
