 ...
 */
public class GLX : gnu.x11.extension.Extension,
  ...
  public const int CLIENT_MINOR_VERSION = 2;
  ...
  // TODO
  private const String CLIENT_EXTENSION_STRING =
    "GL_EXT_abgr"
    + " GL_EXT_blend_color"
...
// GL_SGIX_pixel_texture
  ...
  /**
   * @see #visual_config(int, VisualConfig, bool)
   */
  ...
  public VisualConfig visual_config (int screen_no, 
    VisualConfig template, bool must) {
    ...
    if (!must) return null;
    throw new gnu.x11.Error ("No matching: " + template);
  }
