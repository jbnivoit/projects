...
public class XTest : Extension {
  ...
  public const int CLIENT_MAJOR_VERSION = 2;
  ...
  public const int KEY_PRESS = 2;
  public const int KEY_RELEASE = 3;
  public const int BUTTON_PRESS = 4;
  public const int BUTTON_RELEASE = 5;
  public const int MOTION_NOTIFY = 6;
   ...
   */
  public void fake_button_event (int button, bool press, int delay) {
   ...
   */
  public void fake_key_event (int keycode, bool press, int delay) {
