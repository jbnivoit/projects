...
public class DPMS : Extension {
   ...
   */
  public DPMS (gnu.x11.Display display) 
	//throws NotFoundException 
    :base (display, "DPMS", MINOR_OPCODE_STRINGS) {
  ...
  public bool capable () {
    ...
    return display.read_reply (request).read_bool (8);
  }

  
  /** Reply of {@link #timeouts()} */
  public /*static*/ class TimeoutsReply : Data {
    public TimeoutsReply (Data data) : base (data) {}
  ...
  public const int STAND_BY = 1;
  public const int SUSPEND = 2;
  public const int OFF = 3;


  public static readonly String [] LEVEL_STRINGS
  ...
  /** Reply of {@link #info()} */
  public /*static*/ class InfoReply : Data {
    public InfoReply (Data data) : base (data) {}
    public bool state () { return read_bool (10); }
