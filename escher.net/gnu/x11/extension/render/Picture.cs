...
/** Picture in RENDER. */
public class Picture : gnu.x11.Resource {
  /**
   * Predefined picture.
   *
   * @see gnu.x11.Window#NONE
   */
  public static readonly Picture NONE = new Picture (0);
  ...
  public /*static*/ class Attributes : gnu.x11.ValueList {
    public static readonly Attributes EMPTY = new Attributes ();
    public Attributes () : base (13) {}
     ...
     */
    public void set_repeat (bool b) { set (0, b); }
     ...
     */
    public void set_graphics_exposures (bool b) { set (7, b); }
    ...
    public const int PRECISE = 0;
    public const int IMPRECISE = 1;
     ...
     * @param b default: false
     */
    public void set_component_alpha (bool i) { set (12, i); }
  }
  ...
  public /*static*/ class Format : Data {
    ...
    // GLX uses *_BIT too
    public const int ID_BIT = 1<<0;
    public const int TYPE_BIT = 1<<1;
    public const int DEPTH_BIT = 1<<2;
    public const int RED_BIT = 1<<3;
    public const int RED_MASK_BIT = 1<<4;
    public const int GREEN_BIT = 1<<5;
    public const int GREEN_MASK_BIT = 1<<6;
    public const int BLUE_BIT = 1<<7;
    public const int BLUE_MASK_BIT = 1<<8;
    public const int ALPHA_BIT = 1<<9;
    public const int ALPHA_MASK_BIT = 1<<10;
    public const int COLORMAP_BIT = 1<<10;


    public int bitmask;
  
  
    public Format () : base (LENGTH) {}
    ...
    public /*static*/ class Direct : Data {
    ...
    public bool match (Format template) {
    ...
    public static readonly String [] TYPE_STRINGS = {"indexed", "direct"};
