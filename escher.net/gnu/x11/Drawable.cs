...
/** X drawable. */
public abstract class Drawable : Resource {
  ...
  /**
   * @see #poly_dot(GC, Point[], int, bool)
   */
  ...
  /**
   * @see Drawable#poly_dot(GC, Point[], int, bool)
   */
  ...
  /** 
   * @see #poly_rectangle(GC, Rectangle[], bool)
   */
  public void rectangle (GC gc, Rectangle rectangle, bool fill) {
    poly_rectangle (gc, new Rectangle [] {rectangle}, fill);
  }


  /** 
   * @see #rectangle(GC, Rectangle, bool)
   */      
  ...
  /** 
   * @see #rectangle(GC, int, int, int, int, bool)
   */      
