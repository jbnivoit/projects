...
public class Error : Exception 	{
   ...
   */
  public const int BAD_REQUEST = 1;
   ...
   */
  public const int BAD_DRAWABLE = 9;
   ...
   * already selected.
   */
  public const int BAD_ACCESS = 10;
   ...
   */
  public const int BAD_COLORMAP = 12;
   ...
   * Xlib error.
   */
  public const int BAD_ID_CHOICE = 14;


  /**
   * A font or color of the specified name does not exist.
   */
  public const int BAD_NAME = 15;
   ...
   */
  public const int BAD_LENGTH = 16;
   ...
   */
  public const int BAD_IMPLEMENTATION = 17;
  ...
  public static readonly String [] OPCODE_STRINGS = {
    null,                       // 0
    "CreateWindow",		// 1
  ...
  public static String init (Display display, String error_string, int code,
    ...
    if (code == BAD_COLORMAP
      ...
      Object bad_object = display.resources[bad];
      bad_string = bad_object == null ?
        "\n  bad-id: " + bad
        : "\n  bad-object: " + bad_object;

    } else if (code == BAD_ATOM) {
      Object bad_atom = display.atom_ids[bad];
