...
public class Display {
  ...
  public bool big_requests_present;
  ...
  public /*static*/ class Name {
    ...
    public Name (String display_name) {
      ...
      if (j == -1) {
        ...
        display_no = Int32.Parse (
          display_name.Substring (i+1)); 
        return;
      }
      ...
      display_no = Int32.Parse (
        display_name.Substring (i+1));
      screen_no = Int32.Parse (
        display_name.Substring (j+1));      
    }
   ...
   */
	private /*static*/ class FontsEnum : Enum {
	private Display owner;
		public FontsEnum(Display owner, Data data, int len, int c) : base(data,len,c) { this.owner=owner; }
      public override Object next () {
        return new Font (owner, next_string ());
      }
	}
  ...
  public /*static*/ class ExtensionReply : Data {
    public ExtensionReply (Data data) :base (data) {}
    public bool present () { return read_bool (8); }
  ...
  public static readonly String [] SCREEN_SAVER_STRINGS
    = {"no", "yes", "default"};
  ...
  public /*static*/ class ScreenSaverReply : Data {
    public ScreenSaverReply (Data data) :base (data) {}
  ...
  /** Reply of {@link #hosts()}. */
  public /*static*/ class HostsReply : Data {
    public HostsReply (Data data) :base (data) {}
    public bool mode () { return read_bool (1); }
  }
  ...
  public const int RETAIN_PERMANENT = 1;
  public const int RETAIN_TEMPORARY = 2;
