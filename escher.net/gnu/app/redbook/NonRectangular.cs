 ...
 * help output</a>
 */
public class NonRectangular : gnu.x11.extension.glx.Application {
  private static readonly float [] BLUE_DIFFUSE = new float[]{0.1f, 0.1f, 0.7f, 1.0f};
  private static readonly float [] BLUE_SPECULAR = new float[]{1.0f, 1.0f, 1.0f, 1.0f};
  private static readonly float [] YELLOW_DIFFUSE = new float[]{0.7f, 0.7f, 0.0f, 1.0f};
  private static readonly float [] YELLOW_SPECULAR = new float[]{1.0f, 1.0f, 1.0f, 1.0f};
  private static readonly float [] LIGHT_POSITION = new float[]{1.0f, 1.0f, 1.0f, 0.0f};
