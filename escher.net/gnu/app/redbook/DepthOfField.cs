 ...
 * help output</a>
 */
public class DepthOfField : gnu.x11.extension.glx.Application {
  private const int ACCUM_SIZE = 8;
  ...
  private static readonly float [] LIGHT_POSITION = new float[]{0.0f, 3.0f, 3.0f, 0.0f};
  private static readonly float LIGHT_MODEL_LOCAL_VIEWER = 0.0f;

  private static readonly float [] LIGHT_MODEL_AMBIENT = new float[]{
    0.2f, 0.2f, 0.2f, 1.0f
  };
