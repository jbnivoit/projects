 ...
 * help output</a>
 */
public class AntiAliasedLine : gnu.x11.extension.glx.Application {
  private int rotate_angle;


  public AntiAliasedLine (String [] args)
    : base (args, RESIZE_BIT | KEYBOARD_BIT) {
