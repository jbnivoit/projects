 ...
 * help output</a>
 */
public class AntiAliasPerspective : gnu.x11.extension.glx.Application {
  private const int ACCUM_SIZE = 8;

  private static readonly float [] TORUS_DIFFUSE
    = {0.7f, 0.7f, 0.0f, 1.0f};
  private static readonly float [] CUBE_DIFFUSE
    = {0.0f, 0.7f, 0.7f, 1.0f};
  private static readonly float [] SPHERE_DIFFUSE
    = {0.7f, 0.0f, 0.7f, 1.0f};
  private static readonly float [] OCTAHEDRON_DIFFUSE
    = {0.7f, 0.4f, 0.4f, 1.0f};

  private static readonly float [] LIGHT_MODEL_AMBIENT
    = {0.2f, 0.2f, 0.2f, 1.0f};
  private static readonly float [] LIGHT_POSITION
    = {0.0f, 0.0f, 10.0f, 1.0f};
  private static readonly float [] MATERIAL_AMBIENT
    = {1.0f, 1.0f, 1.0f, 1.0f};
  private static readonly float [] MATERIAL_SPECULAR 
    = {1.0f, 1.0f, 1.0f, 1.0f};
  private static readonly float MATERIAL_SHININESS = 50.0f;
