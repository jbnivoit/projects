 ...
 * help output</a>
 */
public class Clip : gnu.x11.extension.glx.Application {
  private static readonly double [] CLIP_PLANE0 = new double[]{0.0, 1.0, 0.0, 0.0};
  private static readonly double [] CLIP_PLANE1 = new double[]{1.0, 0.0, 0.0, 0.0};
