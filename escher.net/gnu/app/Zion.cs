  ...
  public void run () {
    ...
    try {
      ...
      if (e is InvocationTargetException) {
        ...
        if (e1 is SecurityManager.SubVMExitException) return;
      }
...
class SecurityManager : java.lang.SecurityManager {

  /** Thrown when a sub VM calls {@link java.lang.System#exit(int)}. */
  public class SubVMExitException : SecurityException {}
