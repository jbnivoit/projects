using gnu.x11.GC;
using gnu.x11.Pixmap;
using gnu.x11.extension.render.Picture.Format.Direct;
using gnu.x11.extension.render.Picture;
using gnu.x11.extension.render.Picture.Format;
using gnu.x11.extension.render.Render;
 ...
 * help output</a>
 */
public class Sprites : DisplayHack {
  ...
  public Sprites (String [] args) throws gnu.x11.extension.NotFoundException { 
    base (args, false, false, false, 64, 1000);
