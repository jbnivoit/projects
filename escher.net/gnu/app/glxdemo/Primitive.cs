 ...
 * help output</a>
 */
public class Primitive : gnu.x11.extension.glx.Application {
  private const int COLUMN_COUNT = 4;
  private const int GAP = 10;
  private const int ROW_COUNT = 3;
  private const int BITMAP_WIDTH = 48;
  private const int BITMAP_HEIGHT = 13;


  private static readonly byte [] BITMAP = new byte[]{
  ...
  private static readonly float [] [] COLORS = new float[][]{
  ...
  private bool polygon_fill = true;
  private bool smooth_shade = true;
  private int [] [] vertex_position;


  public Primitive (String [] args)
    : base (args, KEYBOARD_BIT | RESIZE_BIT) {
	vertex_position = new int [8][] { new int[2], new int[2], new int[2], new int[2], new int[2], new int[2], new int[2], new int[2] };
