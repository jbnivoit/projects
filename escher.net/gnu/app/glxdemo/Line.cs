 ...
 * help output</a>
 */
public class Line : gnu.x11.extension.glx.Application {
  private static readonly float [] POINT_A = new float []{-160.0f, 0.0f, 0.0f};
  private static readonly float [] POINT_B = new float []{-130.0f, 0.0f, 0.0f};
  private static readonly float [] POINT_C = new float []{-40.0f, -50.0f, 0.0f};
  private static readonly float [] POINT_D = new float []{300.0f, 60.0f, 0.0f};


  private int draw_size = 1;
  private bool stippling, smoothing;
