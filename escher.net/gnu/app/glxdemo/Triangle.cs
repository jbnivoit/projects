 ...
 * help output</a>
 */
public class Triangle : gnu.x11.extension.glx.Application {
  private const int SOLID = 0;
  private const int LINE = 1;
  private const int POINT = 2;

  private static readonly float [] BOX_A = {-100.0f, -100.0f, 0.0f};
  private static readonly float [] BOX_B = {100.0f, -100.0f, 0.0f};
  private static readonly float [] BOX_C = {100.0f, 100.0f, 0.0f};
  private static readonly float [] BOX_D = {-100.0f, 100.0f, 0.0f};

  private static readonly float [] POINT0 = {-125.0f, -80.0f, 0.0f};
  private static readonly float [] POINT1 = {-125.0f, 80.0f, 0.0f};
  private static readonly float [] POINT2 = {172.0f, 0.0f, 0.0f};
    

  private bool anti_aliasing = false;
  private bool culling = false;
  private bool cull_front = false;
  private bool dithering = true;
  private bool shading = true;
  private bool show_bottom = true;
  private bool show_outline = true;
  private bool show_vertex = true;
