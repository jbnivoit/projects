 ...
 * help output</a>
 */
public class RotateBox : gnu.x11.extension.glx.Application {
  ...
  protected override void handle_button (int button, int state, int x, int y) {
    switch (button) {
    case Input.BUTTON1: x_angle += 10.0f; break;
    case Input.BUTTON2: y_angle += 10.0f; break;
    case Input.BUTTON3: z_angle += 10.0f; break;
    default: return;
    }
